...
export const providerModelCatalog: ProviderModelMetadata[] = [
  ...
  },
  {
    ...
    supportsThinking: false,
    supportedThinkingTypes: ["none"],
    inputCostPer1MTokensUsd: 2.5,
    outputCostPer1MTokensUsd: 15,
    cachedInputCostPer1MTokensUsd: 0.25,
    supportsPromptCaching: true,
    minCacheablePrefixTokens: 1024,
    verifiedDate: "2026-07-11",
    deprecationStatus: "current",
  ...
  },
  {
    ...
    supportsThinking: false,
    supportedThinkingTypes: ["none"],
    inputCostPer1MTokensUsd: 0.75,
    outputCostPer1MTokensUsd: 4.5,
    cachedInputCostPer1MTokensUsd: 0.075,
    supportsPromptCaching: true,
    minCacheablePrefixTokens: 1024,
    verifiedDate: "2026-07-11",
    deprecationStatus: "previous-generation",
  ...
  },
  {
    ...
    cachedInputCostPer1MTokensUsd: 0.02,
    supportsPromptCaching: true,
    minCacheablePrefixTokens: 1024,
    verifiedDate: "2026-07-11",
    deprecationStatus: "previous-generation",
  ...
  },
  {
    ...
    inputCostPer1MTokensUsd: 10,
    outputCostPer1MTokensUsd: 50,
    cachedInputCostPer1MTokensUsd: 1,
    supportsPromptCaching: true,
